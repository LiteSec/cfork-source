...
In order to support loading of multiple wallets in cfork.litesec.name.lower-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cfork.litesec.name.lower.cpp.
...
Changes to cfork.litesec.name.lower.cpp
----------------------
cfork.litesec.name.lower.cpp is the entry point into cfork.litesec.name.lower-qt, and as such, will require some minor modifications to provide hooks for
