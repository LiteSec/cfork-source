...
cfork.litesec.name.cap now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cfork.litesec.name.lower_address\> \<monthly_payment_cfork.litesec.name.lower\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ cfork.litesec.name.cap, _12_ times over the course of a year totaling _24000_ cfork.litesec.name.cap.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cfork.litesec.name.lower_address\> \<monthly_payment_cfork.litesec.name.lower\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` cfork.litesec.name.cap.
