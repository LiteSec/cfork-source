cfork.litesec.name.cap Core version 2.3.1 is now available from:

  <https://github.com/cfork.litesec.name.lower-project/cfork.litesec.name.lower/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/cfork.litesec.name.lower-project/cfork.litesec.name.lower/issues>

Compatibility
==============

cfork.litesec.name.cap Core is extensively tested on multiple operating systems using
...
cfork.litesec.name.cap Core should also work on most other Unix-like systems but is not
...
Examples:
> cfork.litesec.name.lower-cli masternodestart "alias" "my_mn"
...
Examples:
> cfork.litesec.name.lower-cli mnvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
...
Examples:
> cfork.litesec.name.lower-cli getbudgetprojection
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cfork.litesec.name.lower-project-translations/).
