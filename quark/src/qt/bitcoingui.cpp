                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("cfork.litesec.name.cap Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cfork.litesec.name.cap address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cfork.litesec.name.lower: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About cfork.litesec.name.cap Core"), this);
    aboutAction->setStatusTip(tr("Show information about cfork.litesec.name.cap Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cfork.litesec.name.cap"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cfork.litesec.name.cap addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cfork.litesec.name.cap addresses"));
    ...
    openAction->setStatusTip(tr("Open a cfork.litesec.name.cap: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the cfork.litesec.name.cap Core help message to get a list with possible cfork.litesec.name.cap command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("cfork.litesec.name.cap Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cfork.litesec.name.cap network", "", count));
}
...
{
    QString strTitle = tr("cfork.litesec.name.cap Core"); // default title
    ...
    // Append title to "cfork.litesec.name.cap - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
