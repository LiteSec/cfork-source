...
/** cfork.litesec.name.cap unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** cfork.litesec.name.cap units.
      @note Source: https://en.bitcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        cfork.litesec.ticker,
        mcfork.litesec.ticker,
        ucfork.litesec.ticker
    };
