...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("cfork.litesec.name.cap Core"),
     ...
     * override -datadir in the cfork.litesec.name.lower.conf file in the default data directory
     * (to be consistent with cfork.litesec.name.lowerd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
