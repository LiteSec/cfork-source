...
/** Utility functions used by the cfork.litesec.name.cap Qt UI.
 */
namespace GUIUtil
{
...
// Render cfork.litesec.name.cap addresses in monospace font
...
// Parse "cfork.litesec.name.lower:" URI into recipient object, return true on successful parsing
...
// Open cfork.litesec.name.lower.conf
void openConfigfile();
