...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop cfork.litesec.name.cap server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "cfork.litesec.name.cap server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cfork.litesec.name.cap features */
        {"cfork.litesec.name.lower", "masternode", &masternode, true, true, false},
        {"cfork.litesec.name.lower", "listmasternodes", &listmasternodes, true, true, false},
        {"cfork.litesec.name.lower", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cfork.litesec.name.lower", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cfork.litesec.name.lower", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cfork.litesec.name.lower", "masternodedebug", &masternodedebug, true, true, false},
        {"cfork.litesec.name.lower", "startmasternode", &startmasternode, true, true, false},
        {"cfork.litesec.name.lower", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cfork.litesec.name.lower", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cfork.litesec.name.lower", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cfork.litesec.name.lower", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cfork.litesec.name.lower", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cfork.litesec.name.lower", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cfork.litesec.name.lower", "mnbudget", &mnbudget, true, true, false},
        {"cfork.litesec.name.lower", "preparebudget", &preparebudget, true, true, false},
        {"cfork.litesec.name.lower", "submitbudget", &submitbudget, true, true, false},
        {"cfork.litesec.name.lower", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cfork.litesec.name.lower", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cfork.litesec.name.lower", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cfork.litesec.name.lower", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cfork.litesec.name.lower", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cfork.litesec.name.lower", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cfork.litesec.name.lower", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cfork.litesec.name.lower", "checkbudgets", &checkbudgets, true, true, false},
        {"cfork.litesec.name.lower", "mnsync", &mnsync, true, true, false},
        {"cfork.litesec.name.lower", "spork", &spork, true, true, false},
        {"cfork.litesec.name.lower", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cfork.litesec.name.lower", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cfork.litesec.name.lowerd, or the -server option to cfork.litesec.name.lower-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cfork.litesec.name.lower-cli " + methodname + " " + args + "\n";
}
