/* src/config/cfork.litesec.name.lower-config.h.  Generated from cfork.litesec.name.lower-config.h.in by configure.  */
/* src/config/cfork.litesec.name.lower-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cfork.litesec.name.lower.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "cfork.litesec.name.cap Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "cfork.litesec.name.cap Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cfork.litesec.name.lower"
