...
/** 
    ...
    ****Note - for cfork.litesec.name.cap we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of cfork.litesec.name.lower coming in to a transaction
