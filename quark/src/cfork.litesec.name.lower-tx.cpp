...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("cfork.litesec.name.cap Core cfork.litesec.name.lower-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cfork.litesec.name.lower-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cfork.litesec.name.lower transaction") + "\n" +
                               "  cfork.litesec.name.lower-tx [options] -create [commands]   " + _("Create hex-encoded cfork.litesec.name.lower transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cfork.litesec.name.lower transaction
